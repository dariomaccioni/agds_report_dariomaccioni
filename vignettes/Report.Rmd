...
---
```{r}
here::i_am("vignettes/Report.Rmd")
```
...
```{r message = FALSE}
here("data", "data_csv_repexercise.csv")
database_s1 <- readr::read_csv(
  here::here("data","data_csv_repexercise.csv")) # read and import the .csv dataset and creating a new table in R
```
