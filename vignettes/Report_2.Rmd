...
airquality <- dplyr::mutate(`airquality`, `Temp` = (`Temp`-32)*5/9) #convert the Temp column from Fahrenheit to °Celcius
...
ggplot2::ggplot(
  ...
  ggplot2::labs(title = "Relation between Temperature and Solar radiation in New York 1973", subtitle = "Displayed for selected month", y = "Temperatur in [°C]",
...
### Statistical Metrics for Temperature
...
### Statistical Metrics for Solar radiation
